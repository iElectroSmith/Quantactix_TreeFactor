...
public:
    ...
    // constructors
    CTree( ) : theta( 1 , 0.0 ) , Xorder( 0 ) , N( 0 ) , ID( 1 ) , v( 0 ) , c_index( 0 ) , c( 0.0 ) , depth( 0 ) , parentNode( 0 ) , leftChild( 0 ) , rightChild( 0 ) , beta( 0 ) { }
    CTree( size_t dim_theta ) : theta( dim_theta , 0.0 ) , Xorder( 0 ) , N( 0 ) , ID( 1 ) , v( 0 ) , c_index( 0 ) , c( 0.0 ) , depth( 0 ) , parentNode( 0 ) , leftChild( 0 ) , rightChild( 0 ) { ( this->beta ).resize( dim_theta , 1 ); }
    CTree( size_t dim_theta , arma::umat* Xordermat ) : theta( dim_theta , 0.0 ) , Xorder( Xordermat ) , N( 0 ) , ID( 1 ) , v( 0 ) , c_index( 0 ) , c( 0.0 ) , depth( 0 ) , parentNode( 0 ) , leftChild( 0 ) , rightChild( 0 ) { }
    CTree( size_t dim_theta , size_t depth , size_t N , size_t ID , tree_p p , arma::umat* Xordermat ) : theta( dim_theta , 0.0 ) , Xorder( Xordermat ) , N( N ) , ID( ID ) , v( 0 ) , c_index( 0 ) , c( 0.0 ) , depth( depth ) , parentNode( p ) , leftChild( 0 ) , rightChild( 0 ) { ( this->beta ).resize( dim_theta , 1 ); }
