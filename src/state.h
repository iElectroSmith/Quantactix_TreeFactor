...
public:
    ...
    State( arma::mat& X , arma::vec& Y , arma::vec& R , arma::mat& Z , arma::mat& H , 
           arma::vec& portfolio_weight , arma::vec& loss_weight , arma::vec& stocks , arma::vec& months , 
           arma::vec& first_split_var , arma::vec& second_split_var , arma::vec& third_split_var , 
           arma::vec& deep_split_var , size_t& num_months , std::map<size_t , size_t>& months_list , 
           size_t& num_stocks , size_t& min_leaf_size , size_t& max_depth , size_t& num_cutpoints , 
